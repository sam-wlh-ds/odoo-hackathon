    ...
    <nav className="bg-[#14213d] p-4 text-white shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link to="/feedback" className="hover:text-[#fca311]">
            Feedback
          </Link>
          <Link to="/feedback/:swapID" className="hover:text-[#fca311]">
            Feedback swap
          </Link>
          ...
          <Link to="/user/:userId" className="hover:text-[#fca311]">
            other user page
          </Link>
          <Link to="/forgot-password" className="hover:text-[#fca311]">
            forgot password
          </Link>
